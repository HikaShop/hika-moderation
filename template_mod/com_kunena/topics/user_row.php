...
<tr class="<?php echo $this->getTopicClass('k', 'row'); if(!empty($this->topic->moderation_css)) echo ' '.$this->topic->moderation_css; ?>">
	...
	<td class="kcol-mid kcol-ktopictitle">
		...
		<div class="ktopic-title-cover">
			...
			?>
			<?php if(!empty($this->topic->moderation_text)) { echo $this->topic->moderation_text; } ?>
		</div>
